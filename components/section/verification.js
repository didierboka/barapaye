...
export default function Verification(props) {
  ...
  return (
  <View style={{ padding:15, width:'100%', overflow:'scroll' }}>
      <View style={{borderWidth:1, padding:20, borderRadius:15, backgroundColor:'#a3d4e3', borderColor:'#3ba1c3' }}>
         ...
         <Text style={{ fontWeight:'bold', textAlign:'center', color:'red', marginTop:15}}>{ma}</Text>
          <TouchableHighlight  onPress={verification} style={{backgroundColor:'blue', height:45, justifyContent:'center', alignItems:'center', marginTop:20, borderRadius:20,}} disabled={true}>
           {button()}
          </TouchableHighlight>
      </View>
  </View>
